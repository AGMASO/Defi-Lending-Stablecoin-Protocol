...
// contract StopOnRevertHandlerBasedInvariant is StdInvariant, Test {
//     DSCEngine public s_dscEngine;
//     DecentralizedStablecoin public s_usdd;
//     HelperConfig public s_helper;
//     StopOnRevertHandler public s_handler;
...
//         s_handler = new StopOnRevertHandler(s_dscEngine, s_usdd);
//         targetContract(address(s_handler));
//     }
//     /// forge-config: default.invariant.runs = 50
//     /// forge-config: default.invariant.depth = 10
//     /// forge-config: default.invariant.fail-on-revert = true
//     function invariant_protocolMustHaveMoreValueThanSupplyTrue() public view {
...
//         console.log("Total WETH deposited as Collateral: ", wEthValue);
//         uint256 wBtcValue = s_dscEngine.getUsdValueBTC(totalBTCDeposited);
//         console.log("Total WBTC deposited as Collateral: ", wBtcValue);
...
//     /// forge-config: default.invariant.fail-on-revert = true
//     function invariant_gettersShouldNeverRevertTrue() public view {
//         s_dscEngine.getSwETH();
//         s_dscEngine.getSwBTC();
//         s_dscEngine.getSpriceFeedETH();
//         s_dscEngine.getSpriceFeedBTC();
//         s_dscEngine.getSpriceFeedBTC();
//     }
// }
