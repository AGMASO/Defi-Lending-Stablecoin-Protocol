        ...
        <ModalContent>
          <form onSubmit={handleSubmit}>
            ...
            <ModalBody>
              ...
              />
              <Input
                label='Amount of USDD to burn'
                placeholder='Amount of USDD to burn'
                type='text'
                id='amountOfUsddToBurn'
                name='amountOfUsddToBurn'
                value={formData.amountOfUsddToBurn}
                onChange={handleChange}
                variant='bordered'
                className=' text-indigo-600'
              />
